...
const API_KEY = "0795beafac3fe7472a2d96290fe22bfb";
...
const getLatest = (page) => {
    const url = `${URL_PATH}/3/movie/upcoming?api_key=${API_KEY}&language=es-ES&page=${page}`;
...
const renderLatest = async (page) => {
    const movies = await getLatest(page);
...
const renderControls = (page) => {
    const baseUrlPage = "./Peliculas_Nuevas.html?page=";
